...
On this control implementation, uncached semantic routing performed 80 expert misses and 80 unloads across 80 observations. Mean load-stage latency was about 0.369 ms and end-to-end p95 was about 1.664 ms. All-resident performed six cold expert loads, no swaps, and had about 0.470 ms p95 end-to-end latency.
...
The benchmark repeats a mixed-domain sequence with local clusters. Under that order, semantic caching served 30 of 80 expert requests as hits, reduced misses from 80 to 50 and swaps from 80 to 48, lowered mean control load time from about 0.369 ms to 0.238 ms, and lowered p95 end-to-end latency from about 1.664 ms to 1.405 ms without changing selected capacity or control quality.
