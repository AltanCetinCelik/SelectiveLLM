...
```json
{
  ...
  "device": "cpu",
  "device_class": "cpu",
  "git_commit": "1905533d6ccd78d0d3cbbd592298de4788ae50b8",
  "logical_cpus": 10,
  "mps_available": false,
  "os": "Darwin",
  "os_version": "25.5.0",
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| base_only | 80 | 0.431 | 43.1% | 0.125 | 500.0 | 68.4% | 0.397 | 0.527 | 0.000 |
| random | 80 | 0.514 | 51.4% | 0.150 | 860.0 | 45.6% | 1.102 | 1.226 | 0.000 |
| keyword | 80 | 0.503 | 50.3% | 0.198 | 680.0 | 57.0% | 0.450 | 0.808 | 0.000 |
| oracle | 80 | 1.000 | 100.0% | 1.000 | 1019.8 | 35.5% | 1.068 | 1.415 | 0.000 |
| embedding | 80 | 0.760 | 76.0% | 0.633 | 857.8 | 45.7% | 1.238 | 1.618 | 0.000 |
| semantic_top1 | 80 | 0.767 | 76.7% | 0.656 | 680.0 | 57.0% | 1.302 | 1.432 | 0.000 |
| semantic | 80 | 0.801 | 80.1% | 0.696 | 857.8 | 45.7% | 1.310 | 1.664 | 0.000 |
| semantic_threshold_high | 80 | 0.516 | 51.6% | 0.217 | 842.0 | 46.7% | 0.961 | 1.655 | 0.000 |
| semantic_cache | 80 | 0.801 | 80.1% | 0.696 | 857.8 | 45.7% | 1.289 | 1.405 | 0.312 |
| semantic_cache_small | 80 | 0.767 | 76.7% | 0.656 | 680.0 | 57.0% | 1.273 | 1.462 | 0.312 |
| all_resident | 80 | 0.963 | 96.2% | 0.368 | 1580.0 | 0.0% | 0.408 | 0.470 | 0.988 |
...
Semantic routing changed the backend-specific quality score by +0.369 relative to base-only. Its mean routing F1 differed from keyword routing by +0.498. Caching changed mean control-backend load time by -0.131 ms (cached minus uncached). These observations support conclusions only for the labeled backend, workload, configuration, and measurement semantics.
